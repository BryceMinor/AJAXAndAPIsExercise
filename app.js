...
// 4a
const baseURL = `https://www.tvmaze.com/api`;
const id = `38963`;
...
// Example using an arrow function expression (NOTE: A Declaration function can also be used here)
tvMazeFunc = async () => {
    // 4b
    try {
...
.then(res => {
    ...
    console.log(res);
    console.log(res.data.sprite.front_default);
